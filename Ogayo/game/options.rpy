...
define gui.about = _p("""
Программист, разработчик, дизайнер - Komori\n
Сценарист, помощник - Neerwox\n
Сюжет - the Sweetest cake\n

Большинство картинок были взяты из нейросети Kandinsky 2.2\n
Спрайты и прочие png текстуры были сделаны через Photoshop beta 2023\n

P.S. Спасибо, что прочитали нашу игру на раннем этапе разработки.
""")
...
define config.save_directory = "Ogayo-1692033813"
