    ...
    if quick_menu:
        ...
        hbox:
            ...
            button:
                xpos 1580 ypos 775
                xsize 82 ysize 75
                idle_background "sprites/idle button arrow back.png"
                hover_foreground "sprites/hover button arrow back.png"
                action Rollback()
            button:
                xpos 1600 ypos 775
                xsize 82 ysize 75
                idle_background "sprites/idle button arrow next.png"
                hover_foreground "sprites/hover button arrow next.png"
...
screen dictionary():
    tag menu
    add "images/dictionary/dictionary.png"
    ...
    hbox:
        ...
        viewport id "vp":
            ...
            vbox:
                ...
                if persistent.dict1:
                    hbox:
                        add "images/dictionary/mario.png"
                        null width 40
                        text "Марио - это персонаж видеоигр компании Nintendo, созданный Сигэру Миямото.\nВпервые появился в игре для игрового автомата Donkey Kong 1981 года под изначальным именем Прыгун."

                if persistent.dict2:
                    hbox:
                        add "images/dictionary/capabilities.png"
                        null width 40
                        text "Способности - Они используются в игре для того то того то"
                    
                if persistent.dict3:
                    hbox:
                        add "images/dictionary/subaru one.png"
                        null width 40
                        text "Субару 1 - первый прислужник Серполле.\nХарактер: Эмоциональный."

                if persistent.dict4:
                    hbox:
                        add "images/dictionary/subaru two.png"
                        null width 40
                        text "Субару 2 - второй прислужник Серполле.\nХарактер: Спокойный."

                if persistent.dict5:
                    hbox:
                        add "images/dictionary/subaru three.png"
                        null width 40
                        text "Субару 3 - третий прислужник Серполле.\nХарактер: Строгий."

        vbar value YScrollValue("vp")

    textbutton _("Вернуться") xalign 0.05 yalign 0.95 action Return()
...
screen gallery():
    ...
    button:
            xpos 1500 ypos 950
            xsize 380 ysize 86
            idle_background "sprites/arrow_hover.png"
            hover_foreground "sprites/white_idle.png"
            action Return()
    ...
    if quick_menu:
        ...
        hbox:
            ...
            button:
                xpos 1540 ypos 670
                xsize 82 ysize 75
                idle_background "sprites/idle phone button arrow back.png"
                hover_foreground "sprites/hover phone button arrow back.png"
                action Rollback()
            button:
                xpos 1600 ypos 670
                xsize 82 ysize 75
                idle_background "sprites/idle phone button arrow next.png"
                hover_foreground "sprites/hover phone button arrow next.png"
                action Skip() alternate Skip(fast=True, confirm=True)
